...
public class BWInterface {
    ...
    AtomicInteger supplyCap;
    AtomicInteger currentSupply;
    AtomicBoolean connected;
    AtomicBoolean hasWinner;
    Map<Integer, Unit> units;
    Map<Integer, Unit> enemyUnits;
    ConcurrentLinkedQueue<Integer> newUnits;
    ConcurrentLinkedQueue<UnitCommand> commands;
